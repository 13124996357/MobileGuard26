package cn.edu.gdmec.android.mobileguard25.m1home.adapter;
...
public class HomeAdapter extends BaseAdapter{
    private int[] imageId={R.drawable.safe,R.drawable.callmsgsafe,R.drawable.app,
    ...
    private String[] names={
            "手机防盗","通讯卫士","软件管家","手机杀毒","清理","进程管理","流量统计","高级工具","设置中心"
    };
    ...
    public View getView(int i, View view, ViewGroup viewGroup){
        View view1;
        view1 = View.inflate(context, R.layout.item_home,null);
